...
namespace TestExternalConnector.Graph
{
    public class GraphHelper
    {
        ...
        public static Task UpdateConnectionAsync(string id, string name, string? description)
        {
            _ = graphClient ?? throw new MemberAccessException("graphClient is null");

            var updatedConnection = new ExternalConnection
            {
                Id = id,
                Name = name,
                Description = description,
            ...
            return graphClient.External.Connections[id].PatchAsync(updatedConnection);
        }
